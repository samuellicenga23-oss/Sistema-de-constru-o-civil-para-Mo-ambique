...
function Brand({ light = false }: { light?: boolean }) {
  return <div className="flex items-center gap-3">
    <span className="grid h-10 w-10 place-items-center rounded-[11px] bg-[#ed6c22] text-lg font-black text-white">S</span>
    <div><p className={`text-lg font-black tracking-[0.2em] ${light ? "text-white" : "text-[#142033]"}`}>SIGA</p><p className={`text-[9px] font-semibold uppercase tracking-[0.17em] ${light ? "text-slate-400" : "text-slate-500"}`}>Gestão inteligente de obras</p></div>
  </div>;
}

function HeroProduct() {
  return <div className="relative mx-auto w-full max-w-[650px] lg:ml-auto">
    <div className="absolute -left-4 top-16 hidden w-44 rounded-xl border border-[#ded7cb] bg-white p-4 shadow-[0_16px_36px_rgba(20,32,51,.12)] sm:block">
      <p className="text-[9px] font-bold uppercase tracking-[.14em] text-slate-400">Compra recomendada</p>
      <p className="mt-2 text-sm font-black text-[#142033]">Aço A500 · 3,8 t</p>
    ...
    <div className="overflow-hidden rounded-[24px] border border-slate-700 bg-[#142033] p-2.5 shadow-[0_34px_80px_rgba(20,32,51,.2)]">
      <div className="overflow-hidden rounded-[17px] bg-[#f8f9fb]">
        <div className="flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3.5 sm:px-5"><div><p className="text-sm font-black">Residencial Horizonte</p><p className="mt-0.5 text-[10px] text-slate-400">Visão da execução · Actualizado hoje</p></div><span className="rounded-full bg-emerald-50 px-2.5 py-1 text-[10px] font-bold text-emerald-700">Em curso</span></div>
        <div className="grid gap-3 p-3 sm:grid-cols-[1fr_1.7fr] sm:p-4">
          <div className="space-y-3">
            <div className="rounded-xl border border-slate-200 bg-white p-4"><p className="text-[9px] font-bold uppercase tracking-wider text-slate-400">Execução física</p><div className="mt-2 flex items-end justify-between"><strong className="text-3xl font-black tracking-tight">42%</strong><span className="text-[10px] font-bold text-emerald-700">+6% este mês</span></div><div className="mt-3 h-1.5 overflow-hidden rounded-full bg-slate-100"><i className="block h-full w-[42%] bg-[#ed6c22]" /></div></div>
...
function ProductPreview({ active }: { active: ProductKey }) {
  if (active === "orcamento") return <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_24px_60px_rgba(20,32,51,.09)]">
    <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4"><div><p className="text-sm font-black">Mapa de Quantidades · Rev. 03</p><p className="mt-0.5 text-[11px] text-slate-400">Preços actualizados para Maputo</p></div><span className="rounded-full bg-emerald-50 px-3 py-1 text-[10px] font-bold text-emerald-700">98% validado</span></div>
  ...
  if (active === "cronograma") return <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_24px_60px_rgba(20,32,51,.09)]">
    <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4"><div><p className="text-sm font-black">Cronograma de execução</p><p className="mt-0.5 text-[11px] text-slate-400">WBS · linha de base · progresso real</p></div><span className="text-[10px] font-bold text-slate-500">Mar — Ago 2026</span></div>
...
export default function PublicLandingPage() {
  ...
  return <div className="min-h-screen overflow-x-hidden bg-[#f6f1e8] text-[#142033] selection:bg-orange-200">
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[#142033]/10 bg-[#f6f1e8]/95 backdrop-blur-md">
    ...
    <main id="inicio" className="pt-[76px]">
      <section className="relative border-b border-[#142033]/10">
        <div className="mx-auto grid max-w-[1280px] items-center gap-16 px-5 py-16 sm:py-20 lg:grid-cols-[.86fr_1.14fr] lg:px-8 lg:py-24">
          <div className="relative z-10"><p className="mb-6 inline-flex items-center gap-2 border-l-2 border-[#ed6c22] pl-3 text-xs font-black uppercase tracking-[0.14em] text-[#8f4d25]">Da estimativa à obra, tudo ligado</p><h1 className="max-w-[650px] text-[46px] font-black leading-[1.01] tracking-[-0.05em] text-[#101a2c] sm:text-6xl lg:text-[68px]">Controle a obra como ela realmente acontece.</h1><p className="mt-7 max-w-xl text-lg leading-8 text-slate-600">O SIGA liga orçamento, planeamento, compras, campo e medição. A sua equipa trabalha no mesmo fluxo e sabe o que mudou, o que falta e qual é a próxima decisão.</p><div className="mt-9 flex flex-col gap-3 sm:flex-row"><a className="rounded-lg bg-[#ed6c22] px-6 py-3.5 text-center text-sm font-black text-white shadow-[0_10px_26px_rgba(237,108,34,.2)] hover:bg-[#d85f18]" href={whatsappHref()} target="_blank" rel="noreferrer">Ver o SIGA em funcionamento</a><a className="rounded-lg border border-slate-300 bg-white px-6 py-3.5 text-center text-sm font-bold text-slate-800 hover:border-slate-400" href="#plataforma">Explorar a plataforma ↓</a></div><div className="mt-10 grid max-w-xl grid-cols-2 gap-x-6 gap-y-3 border-t border-[#142033]/10 pt-6 text-sm font-semibold text-slate-600 sm:grid-cols-3"><span>✓ MZN e USD</span><span>✓ Computador e telemóvel</span><span>✓ Implementação acompanhada</span></div></div>
          <HeroProduct />
        </div>
      ...
      <section id="plataforma" className="scroll-mt-24 bg-white py-20 lg:py-28">
        <div className="mx-auto max-w-[1280px] px-5 lg:px-8"><div className="grid gap-10 lg:grid-cols-[.78fr_1.22fr] lg:items-end"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-[#d85f18]">Uma operação, não cinco ferramentas</p><h2 className="mt-4 text-4xl font-black leading-tight tracking-[-0.04em] sm:text-5xl">Veja a informação a passar de uma fase para a seguinte.</h2></div><p className="max-w-2xl text-lg leading-8 text-slate-600">O orçamento não termina quando é aprovado. Ele alimenta o cronograma, antecipa compras e dá a referência que o Diário e os Autos precisam para comparar o planeado com o realizado.</p></div>
          <div className="mt-14 grid gap-8 lg:grid-cols-[360px_minmax(0,1fr)] lg:items-start">
            <div className="space-y-2" role="tablist" aria-label="Áreas da plataforma">{(Object.keys(productViews) as ProductKey[]).map((key) => { const view = productViews[key]; const active = key === activeProduct; return <button key={key} type="button" role="tab" aria-selected={active} onClick={() => setActiveProduct(key)} className={`w-full rounded-xl border p-5 text-left transition ${active ? "border-[#142033] bg-[#142033] text-white shadow-lg" : "border-slate-200 bg-white hover:border-slate-400"}`}><span className={`text-[10px] font-black uppercase tracking-[.14em] ${active ? "text-orange-300" : "text-[#d85f18]"}`}>{view.step}</span><strong className="mt-2 block text-lg leading-tight">{view.title}</strong>{active && <><p className="mt-3 text-sm leading-6 text-slate-300">{view.copy}</p><ul className="mt-4 space-y-2 text-xs font-semibold">{view.points.map((point) => <li key={point}>→ {point}</li>)}</ul></>}</button>; })}</div>
            <div role="tabpanel"><ProductPreview active={activeProduct} /></div>
          </div>
        </div>
      </section>

      <section id="solucoes" className="scroll-mt-24 bg-[#142033] py-20 text-white lg:py-28"><div className="mx-auto max-w-[1280px] px-5 lg:px-8"><div className="grid gap-10 lg:grid-cols-[.8fr_1.2fr]"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-orange-300">Cada pessoa vê o que precisa</p><h2 className="mt-4 text-4xl font-black leading-tight tracking-[-0.04em] sm:text-5xl">Um sistema comum para decisões diferentes.</h2><p className="mt-6 max-w-md leading-7 text-slate-300">A mesma informação serve quem prepara o preço, quem coordena o estaleiro e quem precisa de aprovar custos e medições.</p></div><div className="grid gap-4 md:grid-cols-3">{[
      ...
      <section className="bg-[#eef1f4] py-20 lg:py-28"><div className="mx-auto max-w-[1280px] px-5 lg:px-8"><div className="grid gap-12 lg:grid-cols-[.72fr_1.28fr]"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-[#d85f18]">A cadeia de decisão</p><h2 className="mt-4 text-4xl font-black tracking-[-0.04em]">Sem atalhos invisíveis.</h2><p className="mt-5 leading-7 text-slate-600">O SIGA mostra o que falta antes de avançar e conserva a origem de cada valor.</p></div><ol className="relative border-l border-slate-300 pl-8">{[
      ...
      <section id="planos" className="scroll-mt-24 bg-[#f6f1e8] py-20 lg:py-28"><div className="mx-auto max-w-[1280px] px-5 lg:px-8"><div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-[#d85f18]">Planos SIGA</p><h2 className="mt-4 max-w-2xl text-4xl font-black tracking-[-0.04em] sm:text-5xl">Comece com o controlo que a sua equipa precisa.</h2></div><div className="inline-flex w-fit rounded-xl border border-slate-300 bg-white p-1" aria-label="Periodicidade"><button type="button" aria-pressed={!annual} onClick={() => setAnnual(false)} className={`rounded-lg px-4 py-2 text-xs font-bold ${!annual ? "bg-[#142033] text-white" : "text-slate-600"}`}>Mensal</button><button type="button" aria-pressed={annual} onClick={() => setAnnual(true)} className={`rounded-lg px-4 py-2 text-xs font-bold ${annual ? "bg-[#142033] text-white" : "text-slate-600"}`}>Anual <span className={annual ? "text-orange-300" : "text-[#d85f18]"}>−15%</span></button></div></div>
        <div className="mt-14 grid items-stretch gap-5 lg:grid-cols-3">{plans.map((plan) => { const price = annual ? Math.round(plan.monthly * .85) : plan.monthly; return <article key={plan.name} className={`relative flex flex-col rounded-2xl border p-7 ${plan.featured ? "border-[#ed6c22] bg-white shadow-[0_24px_60px_rgba(20,32,51,.12)] lg:-translate-y-3" : "border-slate-200 bg-white/75"}`}>{plan.featured && <span className="absolute right-5 top-0 -translate-y-1/2 rounded-full bg-[#ed6c22] px-3 py-1 text-[10px] font-black uppercase tracking-wider text-white">Recomendado</span>}<p className="text-sm font-black uppercase tracking-[0.1em] text-slate-500">{plan.name}</p><div className="mt-5 flex items-end gap-2"><strong className="text-4xl font-black tracking-[-0.04em]">{price.toLocaleString("pt-PT")}</strong><span className="pb-1 text-sm font-semibold text-slate-500">MZN / mês</span></div><p className="mt-2 min-h-5 text-xs font-semibold text-[#a84a16]">{annual ? "equivalente mensal · facturado anualmente" : "facturação mensal"}</p><p className="mt-5 min-h-[92px] text-sm leading-6 text-slate-600">{plan.description}</p><p className="mt-3 border-y border-slate-100 py-3 text-xs font-bold">{plan.limits}</p><ul className="my-6 flex-1 space-y-3">{plan.features.map((feature) => <li key={feature} className="flex gap-3 text-sm text-slate-700"><span className="font-black text-[#ed6c22]">✓</span><span>{feature}</span></li>)}</ul><a className={`rounded-lg px-4 py-3 text-center text-sm font-black ${plan.featured ? "bg-[#ed6c22] text-white hover:bg-[#d85f18]" : "bg-[#142033] text-white hover:bg-[#24324a]"}`} href={whatsappHref(plan.name)} target="_blank" rel="noreferrer">Falar sobre o {plan.name}</a><a className="mt-2 rounded-lg px-4 py-2.5 text-center text-xs font-bold text-slate-500 hover:bg-slate-50 hover:text-slate-900" href={emailHref(plan.name)}>Receber detalhes por email</a></article>; })}</div><p className="mt-7 text-center text-xs leading-5 text-slate-500">Valores de referência em Meticais. Integrações e desenvolvimento à medida são orçamentados depois do diagnóstico da empresa.</p>
      </div></section>
      ...
      <section id="perguntas" className="scroll-mt-24 bg-white py-20 lg:py-28"><div className="mx-auto grid max-w-[1080px] gap-10 px-5 lg:grid-cols-[.7fr_1.3fr] lg:px-8"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-[#d85f18]">Antes de decidir</p><h2 className="mt-4 text-4xl font-black tracking-[-0.04em]">Perguntas honestas, respostas directas.</h2></div><div className="divide-y divide-slate-200 border-y border-slate-200">{[
          ...
          ["O SIGA funciona no telemóvel?", "Sim. As áreas de consulta e registo foram preparadas para computador, tablet e telemóvel; operações extensas, como o orçamento, são mais confortáveis num ecrã maior."],
      ...
      <section id="contacto" className="bg-white pb-20 lg:pb-28"><div className="mx-auto max-w-[1280px] px-5 lg:px-8"><div className="overflow-hidden rounded-[28px] bg-[#ed6c22] px-7 py-12 text-white md:px-12 lg:flex lg:items-center lg:justify-between lg:px-16 lg:py-16"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-orange-100">Uma conversa, uma obra real</p><h2 className="mt-3 max-w-2xl text-4xl font-black leading-tight tracking-[-0.04em]">Mostre-nos como gere a obra hoje.</h2><p className="mt-4 max-w-xl leading-7 text-orange-50">Usamos o seu fluxo para mostrar onde o SIGA reduz repetição, falhas e decisões tardias.</p></div><div className="mt-9 flex min-w-fit flex-col gap-3 lg:mt-0"><a className="rounded-lg bg-white px-6 py-3.5 text-center text-sm font-black text-[#b8470a]" href={whatsappHref()} target="_blank" rel="noreferrer">WhatsApp · +58 846 63 84 194</a><a className="rounded-lg border border-white/40 px-6 py-3.5 text-center text-sm font-bold text-white hover:bg-white/10" href={emailHref()}>{CONTACT_EMAIL}</a></div></div></div></section>
    </main>

    <footer className="border-t border-slate-800 bg-[#101827] py-10 text-white"><div className="mx-auto flex max-w-[1280px] flex-col gap-8 px-5 sm:flex-row sm:items-end sm:justify-between lg:px-8"><div><Brand light /><p className="mt-5 max-w-sm text-sm leading-6 text-slate-400">Custos, prazo e execução no mesmo sistema de gestão de obras.</p></div><div className="text-sm text-slate-400 sm:text-right"><p>Moçambique · MZN e USD</p><p className="mt-2">© 2026 SIGA. Todos os direitos reservados.</p></div></div></footer>
  </div>;
}
