...
function Brand({ light = false }: { light?: boolean }) {
  return <div className="flex items-center gap-3">
    ...
    <div><p className={`text-lg font-black tracking-[0.2em] ${light ? "text-white" : "text-[#142033]"}`}>SIGO</p><p className={`text-[8px] font-semibold uppercase tracking-[0.12em] ${light ? "text-slate-400" : "text-slate-500"}`}>Sistema Integrado de Gestão de Obras</p></div>
  </div>;
}
